...
public class ReportTest extends AbstractGoalTest {
	...
	public void testReport() {
		try {
			...
			assertTrue(FileUtil.isAccessibleFile(report_dir.resolve("vulas-report.html")));
			assertTrue(FileUtil.isAccessibleFile(report_dir.resolve("vulas-report.json")));
			assertTrue(FileUtil.isAccessibleFile(report_dir.resolve("vulas-report.xml")));
